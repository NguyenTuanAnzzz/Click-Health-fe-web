  ...
  const categories = [
    {
      ...
      icon: Smile,
      color: "bg-[#7AB5E9]/10 text-[#7AB5E9]",
      border: "border-[#7AB5E9]/25",
    ...
    },
    {
      ...
      icon: Dumbbell,
      color: "bg-[#BEDBF4]/20 text-[#1F75C1]",
      border: "border-[#BEDBF4]/30",
    ...
    },
    {
      ...
      icon: Activity,
      color: "bg-[#1F75C1]/10 text-[#1F75C1]",
      border: "border-[#1F75C1]/20",
  ...
  return (
    <UserLayout noPaddingTop={false}>
      <div className="w-full max-w-[1200px] mx-auto px-6 mt-8 pb-24 bg-[#ffffff]">
        ...
        <div className="relative rounded-[24px] bg-[#1F75C1] text-white p-8 md:p-12 mb-16 overflow-hidden shadow-lg">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1 text-left font-inter-tight-small">
              ...
              <h1 className="text-3xl md:text-5xl font-bold font-inter text-white tracking-tight mb-4 leading-tight">
                Luyện tập <span className="text-[#7AB5E9]">Khắc phục</span>
              </h1>
            ...
            <div className="w-full max-w-sm bg-white/5 border border-white/10 rounded-[20px] p-6 backdrop-blur-md shadow-2xl font-inter-tight-small">
              <div className="absolute -top-4 -right-4 bg-[#7AB5E9] text-white w-10 h-10 rounded-full flex items-center justify-center border-2 border-[#1F75C1] rotate-12 shadow-lg">
                <Zap size={18} className="fill-white" />
              </div>
              <div className="space-y-5">
                <div className="flex items-center gap-4 border-b border-white/10 pb-4">
                  <div className="w-9 h-9 bg-white/10 rounded-[10px] flex items-center justify-center text-[#7AB5E9]">
                    <Trophy size={16} />
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-4">
                  <div className="w-9 h-9 bg-[#7AB5E9]/20 rounded-[10px] flex items-center justify-center text-[#7AB5E9]">
                    <Heart size={16} className="fill-[#7AB5E9]" />
                  </div>
                  <div>
                    <p className="text-[10px] font-bold text-[#7AB5E9] uppercase tracking-wider">Chuỗi tích lũy</p>
        ...
        <div>
          <div className="text-center mb-12">
            ...
            <div className="w-12 h-0.5 bg-[#7AB5E9] mx-auto rounded-full" />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {categories.map((cat) => {
              ...
              return (
                <div 
                  key={cat.id} 
                  className="rounded-[20px] bg-[#f0f1f2] border border-transparent p-6 flex flex-col justify-between hover:border-[#1F75C1]/15 hover:bg-[#e9eaec] transition-all duration-300 shadow-sm"
                >
                  <div>
                    ...
                    <div className="space-y-2 mb-8 font-inter-tight-small">
                      {cat.items.map((item, i) => (
                        <div key={i} className="flex items-center gap-2.5 bg-white px-3.5 py-2.5 rounded-lg border border-[#e5e7eb] shadow-2xs">
                          <div className="w-1.5 h-1.5 bg-[#7AB5E9] rounded-full" />
                  ...
                  <button className="w-full bg-[#7AB5E9] text-white py-3 rounded-full font-bold hover:bg-[#5CA5E4] hover:scale-[1.01] transition-all duration-300 flex items-center justify-center gap-2 text-[13px] font-inter-tight-small shadow-sm shadow-[#7AB5E9]/15">
